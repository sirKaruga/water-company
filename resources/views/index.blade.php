            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    <div class="icon p-2 me-2">
                        <img class="img-fluid" src="img/h2ologo.jpeg" alt="Icon" style="width: 30px; height: 30px;">
                    </div>
                    <h1 class="m-0 text-primary">H2O Ambassador LTD</h1>
                </a>
...
<!--  -->
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Company Directors</h1>
                    <p>Our dedicated board of directors is committed to driving our company's success and ensuring the highest
                        standards of corporate governance. They are passionate about delivering exceptional value to our stakeholders,
                        fostering innovation, and making a positive impact on the world.</p>
                </div>
                <!-- <div class="row g-4">
